...
export default function Login() {
  ...
  return (
    <div className="ap-sign">
      <div className="ap-sign-card">
        <Logo size={56} />
        <h1>Sign in</h1>
        <p>Use your Google account to continue. New here? An account is created for you.</p>
        ...
        <p className="ap-sign-fine">We only use your Google name, email and photo.</p>
        <Link to="/" className="ap-sign-back">Back to home</Link>
      </div>
    </div>
  );
}
